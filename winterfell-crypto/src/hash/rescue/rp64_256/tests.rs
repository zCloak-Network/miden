...
fn hash_elements_vs_merge() {
    ...
    let elements: [BaseElement; 8] = [BaseElement::from(14231427221357824276_u64), BaseElement::from(13418178135736470822_u64), BaseElement::from(16108845767609723396_u64), BaseElement::from(12995103415358909307_u64),BaseElement::from(11933225239087204200_u64), BaseElement::from(2786320262238254099_u64), BaseElement::from(2539643165076633674_u64), BaseElement::from(18420984611600581971_u64)];

    println!("the elements are {:?}",elements);
    ...
    println!("the result are {:?}",h_result);
